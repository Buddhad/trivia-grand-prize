...
import { CreditCard, Building, DollarSign, ArrowRight, Shield, Check, AlertCircle, Eye, EyeOff } from 'lucide-react';
...
const BankingSystem: React.FC<BankingSystemProps> = ({ onClose, pendingWinnings = 0 }) => {
  ...
  const [currentView, setCurrentView] = useState<'login' | 'dashboard' | 'transfer' | 'deposit'>('login');
